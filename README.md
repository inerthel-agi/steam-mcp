...
macOS / Linux:
```bash
curl -fsSL https://raw.githubusercontent.com/inerthel-agi/steam-mcp/main/install.sh | bash
```

Windows (PowerShell):
```powershell
irm https://raw.githubusercontent.com/inerthel-agi/steam-mcp/main/install.ps1 | iex
```
